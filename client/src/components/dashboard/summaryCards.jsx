...
export const SummaryCards = ({ userTotalExp, owedAmount, settledUpAmount }) => {
  ...
  return (
    <Grid container spacing={2} justifyContent={"center"} alignItems={"center"}>
      <Grid item xs={12} md={12}>
        ...
        >
          ...
          <Box>
            ...
            >
              $ {convertToCurrency(userTotalExp || 0)}
            </Typography>
          </Box>
        </Stack>
      </Grid>
        ...
        >
          ...
          <Box>
            ...
            <Typography
              ...
              sx={{ color: (theme) => theme.palette["success"].darker }}
            >
              $ {convertToCurrency(settledUpAmount || 0)}
            </Typography>
          </Box>
        </Stack>
      </Grid>
      ...
      <Grid item xs={12} md={4}>
        ...
        >
          <LabelIconStyle
            sx={{ bgcolor: (theme) => theme.palette["error"].dark, py: "18px" }}
          >
            <Iconify
              icon="mdi:cash-minus"
              sx={{ width: "100%", height: "100%", color: "white" }}
          ...
          <Box>
            ...
            >
              $ {convertToCurrency(owedAmount || 0)}
            </Typography>
          </Box>
        </Stack>
      </Grid> */}
